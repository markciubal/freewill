...
export default function JoinPage() {
  ...
  return (
    <form action={action} className="space-y-4">
      ...
      <Field label="Locality" info="locality" hint="Where you actually are: neighborhood, valley, block, mesh node. Anywhere in the world. You can change it later; people near you are the ones who can vouch for you, so be honest.">
