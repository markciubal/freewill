...
export const PROGRAMS: Program[] = [
  ...
  },
  {
    ...
    features: ["OpenStreetMap pin picker at join", "Pins rounded to ~100 m", "Distance on every card", "Within-10-km scope", "Hazard radius circles", "Self-hosted map file (PMTiles) drawn as outlines in your own theme colors", "Works with no internet beyond this server", "Fallback: any raster tile server via NEXT_PUBLIC_TILE_URL"],
  },
  {
    key: "trust",
    name: "Web of Trust",
